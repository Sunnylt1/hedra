const data = [
  ...
  },
  {
    ...
    description:
      "Install guardrails. Install bug screens. Replace broken window panes. Clean windows.",
  },
  {
    id: 4,
    name: "Facade",
    description:
      "Repair exterior envelope. Clean graffiti. Paint stucco walls. Barnish wood elements. Sand and recoat metals.",
  },
  {
    id: 5,
    name: "Common areas",
  ...
  },
  {
    ...
    name: "Roof",
    description:
      "Repair parapets. Repair waterproof layers. Unclog roof drains.",
  },
  {
    id: 14,
    name: "HVAC",
    description:
      "Repair HVAC systems per warranty. Replace broken HVAC components.",
  },
];
